...
public class JEIPlugin implements IModPlugin {
    ...
    public void registerItemSubtypes(ISubtypeRegistration registration) {
        for (AmuletItem item : AmuletItem.getAmulets()) {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        // Item descriptions
        registration.addIngredientInfo(AmuletItem.getAmulets().stream().map(ItemStack::new).collect(Collectors.toList()), VanillaTypes.ITEM, new TranslationTextComponent("jei.elementalamulets.amulets.description"));
