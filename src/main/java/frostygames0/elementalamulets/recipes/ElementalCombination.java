...
public class ElementalCombination implements IRecipe<IInventory> {
    ...
    public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<ElementalCombination> {
        @Override
