...
public class TagProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        getOrCreateBuilder(ModTags.EARTH_ELEMENT_CONVERTIBLE).addTag(ItemTags.FLOWERS).add(Items.DIRT, Items.COARSE_DIRT, Items.GRASS_BLOCK).addTag(ItemTags.LOGS).addTag(ItemTags.PLANKS);
    }
}
