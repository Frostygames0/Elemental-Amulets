...
public class TagProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        // Water
        this.getOrCreateBuilder(ModTags.WATER_ELEMENT_CONVERTIBLE).add(Items.WATER_BUCKET, Items.WET_SPONGE, Items.HEART_OF_THE_SEA,
        ...
        // Air
        this.getOrCreateBuilder(ModTags.AIR_ELEMENT_CONVERTIBLE).add(Items.FEATHER, Items.FIREWORK_ROCKET).addTags(ItemTags.SAND, ItemTags.WOOL);
        // Earth
        this.getOrCreateBuilder(ModTags.EARTH_ELEMENT_CONVERTIBLE).add(Items.DIRT, Items.COARSE_DIRT, Items.GRASS_BLOCK).addTags(ItemTags.FLOWERS, ItemTags.LEAVES, ItemTags.LOGS);
    }
}
