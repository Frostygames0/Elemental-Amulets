...
public class OrePlacements {
    public static final Lazy<PlacedFeature> ELEMENTAL_ORE_UPPER = Lazy.of(() -> PlacementUtils.register("elementalamulets:elemental_ore_upper", OreFeatures.ELEMENTAL_ORE.get().placed(orePlacement(80, HeightRangePlacement.triangle(VerticalAnchor.absolute(80), VerticalAnchor.absolute(384))))));
