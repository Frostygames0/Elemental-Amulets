...
public class LeafShield extends EntityModel<Entity> {
	...
	public LeafShield() {
		...
		leafPart1.setTextureOffset(10, 6).addBox(-8.0F, -12.0F, -4.0F, 1.0F, 6.0F, 8.0F, 0.0F, false);
		leafPart1.setTextureOffset(20, 0).addBox(-4.0F, -12.0F, -8.0F, 8.0F, 6.0F, 1.0F, 0.0F, false);

		cube_r1_r1 = new ModelRenderer(this);
		cube_r1_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
		leafPart1.addChild(cube_r1_r1);
		setRotationAngle(cube_r1_r1, 0.0F, 0.7854F, 0.0F);
		cube_r1_r1.setTextureOffset(20, 7).addBox(-3.0F, -12.0F, -8.35F, 6.0F, 6.0F, 1.0F, 0.0F, false);

		leafPart2 = new ModelRenderer(this);
		leafPart2.setRotationPoint(0.0F, 24.0F, 0.0F);
		leafPart2.setTextureOffset(0, 0).addBox(7.0F, -12.0F, -4.0F, 1.0F, 6.0F, 8.0F, 0.0F, false);
		...
		cube_r2_r1.setTextureOffset(18, 20).addBox(-3.0F, -12.0F, 7.35F, 6.0F, 6.0F, 1.0F, 0.0F, false);
	}
