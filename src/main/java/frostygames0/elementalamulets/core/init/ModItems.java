...
public class ModItems {
    ...
    public static final RegistryObject<Item> SPEED_AMULET = ITEMS.register("speed_amulet",
            () -> new SpeedAmulet(new Item.Properties().group(null).rarity(ElementalColors.WATER).maxDamage(1000).isImmuneToFire(),1));
    public static final RegistryObject<Item> SPEED_AMULET_TIER2 = ITEMS.register("speed_amulet_tier2",
            () -> new SpeedAmulet(new Item.Properties().group(null).rarity(ElementalColors.WATER).maxDamage(1200).isImmuneToFire(),2));
    public static final RegistryObject<Item> SPEED_AMULET_TIER3 = ITEMS.register("speed_amulet_tier3",
            () -> new SpeedAmulet(new Item.Properties().group(null).rarity(ElementalColors.WATER).maxDamage(1400).isImmuneToFire(),3));
    public static final RegistryObject<Item> SPEED_AMULET_TIER4 = ITEMS.register("speed_amulet_tier4",
            () -> new SpeedAmulet(new Item.Properties().group(null).rarity(ElementalColors.WATER).maxDamage(1600).isImmuneToFire(),4));
    ...
    public static final RegistryObject<Item> INVISIBILITY_AMULET = ITEMS.register("invisibility_amulet",
            () -> new InvisibilityAmulet(new Item.Properties().group(null).rarity(ElementalColors.AIR).maxDamage(1000).isImmuneToFire()));
