...
public class ElementalColors {
    ...
    public static final Rarity WATER = Rarity.create(modPrefix("water_rarity").toString(), TextFormatting.AQUA);
    ...
    // Sub-elements
    public static final Rarity SPEED = Rarity.create(modPrefix("speed_rarity").toString(), TextFormatting.BLUE);
