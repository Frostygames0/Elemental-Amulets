...
public class ModItems {
    ...
    public static final RegistryObject<Item> CELESTIAL_FOCUS = ITEMS.register("celestial_focus",
            () -> new BlockItem(ModBlocks.CELESTIAL_FOCUS.get(), new Item.Properties().tab(ElementalAmulets.GROUP)));
    public static final RegistryObject<Item> ELEMENTAL_ORE = ITEMS.register("elemental_ore",
            () -> new BlockItem(ModBlocks.ELEMENTAL_ORE.get(), new Item.Properties().tab(ElementalAmulets.GROUP)));
    public static final RegistryObject<Item> DEEPSLATE_ELEMENTAL_ORE = ITEMS.register("deepslate_elemental_ore",
            () -> new BlockItem(ModBlocks.DEEPSLATE_ELEMENTAL_ORE.get(), new Item.Properties().tab(ElementalAmulets.GROUP)));
    public static final RegistryObject<Item> ELEMENTAL_SHARDS_BLOCK = ITEMS.register("elemental_shards_block",
            () -> new BlockItem(ModBlocks.ELEMENTAL_SHARDS_BLOCK.get(), new Item.Properties().tab(ElementalAmulets.GROUP)));
    public static final RegistryObject<Item> FIRE_SHARDS_BLOCK = ITEMS.register("fire_shards_block",
    ...
    public static final RegistryObject<Item> WATER_SHARDS_BLOCK = ITEMS.register("water_shards_block",
    ...
    public static final RegistryObject<Item> EARTH_SHARDS_BLOCK = ITEMS.register("earth_shards_block",
    ...
    public static final RegistryObject<Item> AIR_SHARDS_BLOCK = ITEMS.register("air_shards_block",
